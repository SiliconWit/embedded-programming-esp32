...
heroImage: "https://cdn.siliconwit.com/education/embedded-programming-esp32/power-management-deep-sleep.png"
---
...
:::tip[Instrument it]
A remote sensor that flattens its battery in a week is not a monitor, it is a chore. Deep sleep is what makes battery-powered monitoring practical: wake on a timer or an interrupt, take the reading, publish, and drop back to microamps, so a couple of AA cells or a small LiPo can run a node for months. Match the wake interval to how fast the thing you watch actually changes, then the node can [report on schedule](/education/iot-systems/) to [siliconwit.io](https://siliconwit.io) and still be alive next season.
:::
