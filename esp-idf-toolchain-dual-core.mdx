...
The wiring diagram and parts list are below. Switch to **Explained** to see the full implementation with code, or **Advanced** for the engineering details behind the design choices.
